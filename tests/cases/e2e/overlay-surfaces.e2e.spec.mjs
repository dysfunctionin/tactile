...
scenario("paper formatting, context, and tooltip surfaces stay opaque and above clipping", async ({ page }) => {
  await page.goto("/");
...
scenario("cell menus stay close to lower cells and keep submenus inside the viewport", async ({ page }) => {
  await page.goto("/");
...
scenario("row and column insertion visibly shifts sheet cells", async ({ page }) => {
  await page.goto("/");
