...
const scenario = defineSuite({ type: "e2e", suite: "marketplace-lifecycle" });

scenario("marketplace owns install, version updates, and delete while Cell Objects owns enablement", async ({ page }) => {
  const pageErrors = [];
