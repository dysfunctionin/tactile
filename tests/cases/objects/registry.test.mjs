...
scenario("registers every existing object type with a lazy renderer contract", () => {
...
scenario("renderer loading is explicit and remains bundler-owned", () => {
...
scenario("unknown optional types resolve to the explicit missing-plugin renderer", () => {
