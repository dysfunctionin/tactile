...
scenario("the manager deduplicates store reads and caches matching windows", async () => {
  let reads = 0;
...
scenario("the manager rejects a store response at the wrong revision", async () => {
...
scenario("revision notifications invalidate cached and in-flight stale windows", async () => {
  let resolveRead;
...
scenario("the manager rejects mismatched projections before caching", async () => {
