...
scenario("auto row heights consume journaled cell changes without rebuilding state", () => {
  const cells = {
...
scenario("live drafts update only their projected row and do not mutate committed state", () => {
  const cells = {
...
scenario("structural changes remap existing height contributions", () => {
  const cells = {
    r2c1: {
      id: "r2c1",
      row: 1,
