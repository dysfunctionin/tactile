...
- In browsers, each tab owns an isolated ephemeral workspace database; preserve reload reuse, fresh-tab blank state, live-tab exclusion during cleanup, and close protection together. See ADR 0002.
